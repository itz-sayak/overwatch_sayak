...
from overwatch_sayak.dataset.utils import approximate_mask_with_polygons
from overwatch_sayak.detection.core import Detections
from overwatch_sayak.detection.utils import polygon_to_mask, polygon_to_xyxy
...
def object_to_pascal_voc(
    ...
    # https://github.com/roboflow/overwatch_sayak/issues/144
    xyxy += 1
