...
from overwatch_sayak.config import CLASS_NAME_DATA_FIELD, ORIENTED_BOX_COORDINATES
from overwatch_sayak.detection.lmm import LMM, from_paligemma, validate_lmm_and_kwargs
...
from overwatch_sayak.geometry.core import Position
from overwatch_sayak.utils.internal import deprecated, get_instance_variables
from overwatch_sayak.validators import validate_detections_fields


@dataclass
class Detections:
    """
    The `ov.Detections` class in the Supervision library standardizes results from
    ...
    === "Inference"
        ...
        Use [`ov.Detections.from_inference`](/detection/core/#overwatch.detection.core.Detections.from_inference)
        ...
        detections = ov.Detections.from_inference(results)
        ```

    === "Ultralytics"

        Use [`ov.Detections.from_ultralytics`](/detection/core/#overwatch.detection.core.Detections.from_ultralytics)
        method, which accepts model results from both detection and segmentation models.
        ...
        detections = ov.Detections.from_ultralytics(results)
        ```

    === "Transformers"

        Use [`ov.Detections.from_transformers`](/detection/core/#overwatch.detection.core.Detections.from_transformers)
        method, which accepts model results from both detection and segmentation models.
        ...
        detections = ov.Detections.from_transformers(
    ...
    def from_ultralytics(cls, ultralytics_results) -> Detections:
        """
        Creates a `ov.Detections` instance from a
    ...
    def from_yolo_nas(cls, yolo_nas_results) -> Detections:
        ...
        Example:
            ...
            detections = ov.Detections.from_yolo_nas(result)
            ```
        """
    ...
    def from_tensorflow(
        ...
        Example:
            ...
            result = model(img)
            detections = ov.Detections.from_tensorflow(result)
            ```
        """  # noqa: E501 // docs
    ...
    def from_deepsparse(cls, deepsparse_results) -> Detections:
        ...
        Example:
            ...
            detections = ov.Detections.from_deepsparse(result)
            ```
        """  # noqa: E501 // docs
    ...
    def from_mmdetection(cls, mmdet_results) -> Detections:
        ...
        Example:
            ...
            detections = ov.Detections.from_mmdetection(result)
            ```
        """  # noqa: E501 // docs
    ...
    def from_detectron2(cls, detectron2_results) -> Detections:
        ...
        Example:
            ...
            detections = ov.Detections.from_detectron2(result)
            ```
        """
    ...
    def from_inference(cls, roboflow_result: Union[dict, Any]) -> Detections:
        """
        Create a `ov.Detections` object from the [Roboflow](https://roboflow.com/)
    ...
    @deprecated(
        ...
        "`overwatch-0.22.0`. Use `Detections.from_inference` instead."
    )
    def from_roboflow(cls, roboflow_result: Union[dict, Any]) -> Detections:
        ...
        Example:
            ...
            result = model.infer(image)[0]
            detections = ov.Detections.from_roboflow(result)
            ```
        """
    ...
    def from_sam(cls, sam_result: List[dict]) -> Detections:
        ...
        Example:
            ...
            detections = ov.Detections.from_sam(sam_result=sam_result)
            ```
        """
    ...
    def from_azure_analyze_image(
        ...
        Example:
            ...
            detections = ov.Detections.from_azure_analyze_image(response)
            ```
        """
    ...
    def from_paddledet(cls, paddledet_result) -> Detections:
        ...
        Example:
            ...
            detections = ov.Detections.from_paddledet(paddledet_result)
            ```
        """
    ...
    def from_lmm(cls, lmm: Union[LMM, str], result: str, **kwargs) -> Detections:
        ...
        Examples:
            ...
            detections = ov.Detections.from_lmm(
                ov.LMM.PALIGEMMA,
                paligemma_result,
    ...
    def empty(cls) -> Detections:
        ...
        Example:
            ```python
            from overwatch import Detections
    ...
    def with_nmm(
        ...
        ![non-max-merging](https://media.roboflow.com/overwatch-docs/non-max-merging.png){ align=center width="800" }
        """  # noqa: E501 // docs
        if len(self) == 0:
            return self
