...
class Classifications:
    ...
    def from_clip(cls, clip_results) -> Classifications:
        ...
        Example:
            ...
            classifications = ov.Classifications.from_clip(output)
            ```
        """
    ...
    def from_ultralytics(cls, ultralytics_results) -> Classifications:
        ...
        Example:
            ...
            classifications = ov.Classifications.from_ultralytics(output)
            ```
        """
    ...
    def from_timm(cls, timm_results) -> Classifications:
        ...
        Example:
            ...
            classifications = ov.Classifications.from_timm(output)
            ```
        """
