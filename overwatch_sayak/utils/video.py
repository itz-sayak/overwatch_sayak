...
from overwatch_sayak.utils.internal import deprecated
...
class VideoInfo:
    ...
    Examples:
        ...
        video_info = ov.VideoInfo.from_video_path(video_path=<SOURCE_VIDEO_FILE>)
...
class VideoSink:
    ...
    Example:
        ...
        video_info = ov.VideoInfo.from_video_path(<SOURCE_VIDEO_PATH>)
        frames_generator = ov.get_video_frames_generator(<SOURCE_VIDEO_PATH>)

        with ov.VideoSink(target_path=<TARGET_VIDEO_PATH>, video_info=video_info) as sink:
...
def get_video_frames_generator(
    ...
    Examples:
        ...
        for frame in ov.get_video_frames_generator(source_path=<SOURCE_VIDEO_PATH>):
            ...
        ```
    """
...
class FPSMonitor:
    ...
    def __init__(self, sample_size: int = 30):
        ...
        Examples:
            ...
            frames_generator = ov.get_video_frames_generator(source_path=<SOURCE_FILE_PATH>)
            fps_monitor = ov.FPSMonitor()
    ...
    @deprecated(
        ...
        "`overwatch_sayak-0.22.0`. Use `FPSMonitor.fps` instead."
    )
