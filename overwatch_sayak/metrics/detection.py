...
from overwatch_sayak.dataset.core import DetectionDataset
from overwatch_sayak.detection.core import Detections
from overwatch_sayak.detection.utils import box_iou_batch
...
def detections_to_tensor(
    ...
    Args:
        detections (ov.Detections): Detections/Targets in the format of ov.Detections
...
class ConfusionMatrix:
    ...
    def from_detections(
        ...
        Example:
            ...
            confusion_matrix = ov.ConfusionMatrix.from_detections(
    ...
    def from_tensors(
        ...
        Example:
            ...
            confusion_matrix = ov.ConfusionMatrix.from_tensors(
                predictions=predictions,
                targets=targets,
                classes=['person', ...]
            )
    ...
    def benchmark(
        ...
        Example:
            ...
            model = YOLO(...)
            def callback(image: np.ndarray) -> ov.Detections:
                result = model(image)[0]
                return ov.Detections.from_ultralytics(result)

            confusion_matrix = ov.ConfusionMatrix.benchmark(
                dataset = dataset,
                callback = callback
            )
...
class MeanAveragePrecision:
    ...
    def from_detections(
        ...
        Example:
            ...
            mean_average_precision = ov.MeanAveragePrecision.from_detections(
                predictions=predictions,
                targets=target,
            )
    ...
    def benchmark(
        ...
        Example:
            ...
            mean_average_precision = ov.MeanAveragePrecision.benchmark(
                dataset = dataset,
                callback = callback
            )
    ...
    def from_tensors(
        ...
        Example:
            ...
            mean_average_precison = ov.MeanAveragePrecision.from_tensors(
                predictions=predictions,
                targets=targets,
            )
