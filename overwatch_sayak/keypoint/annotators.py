...
from overwatch_sayak import Rect, pad_boxes
from overwatch_sayak.annotators.base import ImageType
from overwatch_sayak.draw.color import Color
from overwatch_sayak.draw.utils import draw_rounded_rectangle
from overwatch_sayak.keypoint.core import KeyPoints
from overwatch_sayak.keypoint.skeletons import SKELETONS_BY_VERTEX_COUNT
from overwatch_sayak.utils.conversion import convert_for_annotation_method
...
class VertexAnnotator(BaseKeyPointAnnotator):
    ...
    def annotate(self, scene: ImageType, key_points: KeyPoints) -> ImageType:
        ...
        Example:
            ...
            vertex_annotator = ov.VertexAnnotator(
                color=ov.Color.GREEN,
                radius=10
            )
        ...
        overwatch-annotator-examples/vertex-annotator-example.png)
        """
        if len(key_points) == 0:
            return scene
...
class EdgeAnnotator(BaseKeyPointAnnotator):
    ...
    def annotate(self, scene: ImageType, key_points: KeyPoints) -> ImageType:
        ...
        Example:
            ...
            edge_annotator = ov.EdgeAnnotator(
                color=ov.Color.GREEN,
                thickness=5
            )
        ...
        overwatch-annotator-examples/edge-annotator-example.png)
        """
        if len(key_points) == 0:
            return scene
...
class VertexLabelAnnotator:
    ...
    def annotate(
        ...
        Example:
            ...
            vertex_label_annotator = ov.VertexLabelAnnotator(
                color=ov.Color.GREEN,
                text_color=ov.Color.BLACK,
                border_radius=5
            )
        ...
        overwatch-annotator-examples/vertex-label-annotator-example.png)
        ...
        Example:
            ...
            COLORS = [ov.Color.from_hex(color_hex=c) for c in COLORS]
        ...
        overwatch-annotator-examples/vertex-label-annotator-custom-example.png)
        """
